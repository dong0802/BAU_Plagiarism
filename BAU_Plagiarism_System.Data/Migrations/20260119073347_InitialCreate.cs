        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LecturerId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OverallSimilarityPercentage = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    TotalMatchedDocuments = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlagiarismChecks_Documents_SourceDocumentId",
                        column: x => x.SourceDocumentId,
                        principalTable: "Documents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlagiarismChecks_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PlagiarismCheckId = table.Column<int>(type: "int", nullable: false),
                    MatchedDocumentId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlagiarismMatches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlagiarismMatches_Documents_MatchedDocumentId",
                        column: x => x.MatchedDocumentId,
                        principalTable: "Documents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PlagiarismMatches_PlagiarismChecks_PlagiarismCheckId",
                        column: x => x.PlagiarismCheckId,
                        principalTable: "PlagiarismChecks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlagiarismChecks_CheckDate",
                table: "PlagiarismChecks",
                column: "CheckDate");

            migrationBuilder.CreateIndex(
                name: "IX_PlagiarismChecks_SourceDocumentId",
                table: "PlagiarismChecks",
                column: "SourceDocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_PlagiarismChecks_UserId",
                table: "PlagiarismChecks",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_PlagiarismMatches_MatchedDocumentId",
                table: "PlagiarismMatches",
                column: "MatchedDocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_PlagiarismMatches_PlagiarismCheckId",
                table: "PlagiarismMatches",
                column: "PlagiarismCheckId");
